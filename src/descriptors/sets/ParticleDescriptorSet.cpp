...
#include "ParticleDescriptorSet.hpp"

#include <iostream>
#include <string>

ParticleDescriptorSet::ParticleDescriptorSet(
...
void ParticleDescriptorSet::bind(VkCommandBuffer commandbuffer, uint32_t frame) {
...
VkBuffer ParticleDescriptorSet::get_buffer(uint32_t current_frame) {

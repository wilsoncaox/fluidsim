...
#include "ParticleDensityDescriptorSet.hpp"

#include <iostream>

ParticleDensityDescriptorSet::ParticleDensityDescriptorSet(
...
void ParticleDensityDescriptorSet::bind(VkCommandBuffer commandbuffer, uint32_t frame) {
...
VkBuffer ParticleDensityDescriptorSet::get_buffer(uint32_t current_frame) {
